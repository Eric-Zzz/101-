...
def getnumber(i,j):
    ...
    if vot2 == "z_btn_vote z_disabled":
        ...
        for idol in star:
            newstar.append(idol)
        print(newstar)
        driver.get_screenshot_as_file('{0}-{1}.png'.format(i, j+1))
        tag.tagimage('{0}-{1}.png'.format(i, j+1), call, newstar[j+1],i)
